...
<body>
	...
	<table border="1" style="text-align: center">
		...
		<c:forEach var="emcdonald" items="${emcdonaldDetail}">
			<tr>
				<td>${emcdonald.menu_name}</td><td>${emcdonald.amount}</td>
		...
		<tr>
			<th colspan="2"></th><th>총가격</th><th>총주문가격</th><th>총세금</th><th>총수입</th><th>총판매개수</th>
		</tr>
		<tr>
		<td colspan="2">총합계</td>
		...
		<c:forEach var="emcdonald" items="${emcdonaldDetail}">
				<c:set var="amount" value="${amount+emcdonald.amount}"/>	
		</c:forEach>
